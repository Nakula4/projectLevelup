  ...
  void _nextSet() {
    setState(() {
      ...
      int totalSetsForCurrentExercise =
          widget.exercises[_currentExerciseIndex]['sets'] ?? 3;
  ...
  Future<void> _claimReward() async {
    ...
    try {
      ...
      if (playerQuery.docs.isNotEmpty) {
        ...
        // ✅ PASTI: +1 atribut sebagai reward menyelesaikan quest
        newStatValue += 1;
        ...
        while (newExp >= getMaxExp(newLevel)) {
          ...
          newLevel += 1;
          newStatValue += 1; // ✅ BONUS: +1 lagi setiap naik level
          leveledUp = true;
        }
                ...
                return AlertDialog(
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      const Text(
                        'Your physical achievements have been recognized by the System.',
                        textAlign: TextAlign.center,
                        style: TextStyle(color: Colors.white54, fontSize: 12),
                      ),
                    ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'GERAKAN ${_currentExerciseIndex + 1} DARI ${widget.exercises.length}',
          style: const TextStyle(
            color: Colors.white54,
            fontSize: 13,
            fontWeight: FontWeight.bold,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                color: _isResting ? Colors.amber : Colors.blueAccent,
                fontWeight: FontWeight.bold,
                letterSpacing: 1.5,
              ),
            ),
            ...
            const SizedBox(height: 60),
            Text(
              'SET $_currentSet DARI $totalSets',
              style: const TextStyle(
                color: Colors.white70,
                fontSize: 18,
                fontWeight: FontWeight.bold,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  side: BorderSide(
                    color: _isResting ? Colors.white24 : Colors.blueAccent,
                    width: 2,
                  ),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(8),
                ...
                child: Text(
                  _isResting ? 'LEWATI ISTIRAHAT' : 'SELESAI SET',
                  style: TextStyle(
                    color: _isResting
                        ? Colors.white70
